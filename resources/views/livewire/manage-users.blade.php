<div class="flex flex-col">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <button href="#" class="text-indigo-600 hover:text-indigo-900" wire:click="confirmDelete({{ $user->id }})">Delete</button>
                            </td>
                        </tr>
                        @endforeach
    ...
    <x-confirmation-modal wire:model.defer="showDeleteUserModal">
        ...
        <x-slot name='footer'>
            <x-button class="bg-gray-400 hover:bg-gray-500" wire:click="cancel">Cancle</x-button>
